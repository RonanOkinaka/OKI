...
namespace ext
{
    namespace intl_
    {
        ...
        public:
            ...
            {
                auto now = Clock::now();
                return this->get_diff_(
                    std::exchange(start_, now),
                    now
                );
            }
        ...
        private:
            ...
            static Type get_diff_(
                const TimePoint& early,
    ...
    using StopWatch = ext::intl_::BasicStopWatch<
